            ...
            <section class="story-area pb-120">
                <div class="container">
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="row g-5 align-items-star">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="story__item inner-page">
                                            ...
                                            <div
                                                class="d-flex align-items-center flex-wrap gap-3 justify-content-between mt-20">
                                                <div>
                                                    <h3 class="mb-2"><a href="#0">Sequence - Financial Dashboard</a>
                                                    </h3>
                                                    <div class="story__info">
                                                        <ul>
                                                            <li>UI/UX Design</li>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="story__item inner-page mt-minus">
                                            <div class="image">
                                            ...
                                            <div
                                                class="d-flex align-items-center flex-wrap gap-3 justify-content-between mt-20">
                                                <div>
                                                    <h3 class="mb-2"><a href="#0">ARTVISTA - Art Gallery Website</a>
                                                    </h3>
                                                    <div class="story__info">
                                                        <ul>
                                                            <li>UI/UX Design</li>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="story__item inner-page">
                                            ...
                                            <div
                                                class="d-flex align-items-center flex-wrap gap-3 justify-content-between mt-20">
                                                <div>
                                                    <h3 class="mb-2"><a href="#0">Punto - Product Development</a></h3>
                                                    <div class="story__info">
                                                        <ul>
                                                            <li>UI/UX Design</li>
                                                            <li class="li-dot"></li>
                    ...
                    <div class="story__btn mt-80">
                        <a href="#0" class="btn-three">Explore More<i class="fa-regular fa-arrow-right"></i></a>
                        <div class="story__scrollbar">
