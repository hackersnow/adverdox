...
<body>
    ...
    <div class="ScrollSmoother-content">
        ...
        <main>
            ...
            <section class="banner-inner-area">
                <div class="container">
                    <div class="banner-inner__content">
                        <a href='index.html'>home</a><span>/Pricing Plan</span>
                        <h2>Pricing Plan</h2>
            ...
            <section class="pricing-two-area pb-120">
                <div class="container">
                    <div class="section-header text-center mb-80">
                        <h2 class="fw-300">Choose Your Best Plan</h2>
                        <p>Discover the transformative impact of our digital marketing expertise through <br> the words
                            of
                            those
                            who matter most – our
                            clients.</p>
                    </div>
                    <div class="d-flex justify-content-center mb-80">
                                ...
                                <div class="pricing-package-wrapper">
                                    <div class="row g-4">
                                        <div class="col-xl-4 col-md-6">
                                            <div class="pricing-two__item gray__bg">
            ...
            <section class="pricing-table-area pb-120">
                <div class="container">
                    <div class="section-header text-center mb-80">
                        <h2 class="fw-300">Features comparison</h2>
                        <p>Compare our plans side by side to find the perfect fit for your needs.p>
                    </div>
                    <div class="pricing-table__wrp table-responsive">
                        <table class="table mb-30">
                            ...
                            <tbody>
                                <tr>
                                    <td>Realtime analytics</td>
                                    <td><i class="fa-regular fa-check"></i></td>
                                    <td><i class="fa-regular fa-check"></i></td>
                                    <td><i class="fa-regular fa-check"></i></td>
                                </tr>
                                <tr>
