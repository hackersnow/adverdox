        ...
        <div class="container">
            <div class="header__main header__main-one">
                    ...
                    <nav>
                        <ul> 
                            ...
                            <li>
                                ...
                                <ul class="sub-menu">
                                    <li>
                                        <a href='service.php'> Website Development</a>
                                    </li>
                                    <li>
                                        <a href='service.php'>Android Development</a>
                                    </li>
                                    <li>
                                        <a href='service.php'>Grapics Design</a>
                                    </li>
                                    <li>
                                        <a href='service.php'>Seo & Degital Marketing</a>
                                    </li>
                                    <li>
                                        <a href='service.php'>CRM & ERP Development</a>
                                    </li>
                                </ul>
                            </li>

                            <li>
                                <a href="case-study.php">Portfolio </a>
                            </li>
                ...
                <div class="menu-btns d-none d-lg-flex">
                    <a class='menu-btn-one' href='contact.php'>Contact Us</a>
                </div>
    ...
    <div class="sidebar-area offcanvas offcanvas-end" id="menubar">
        ...
        <div class="offcanvas-body sidebar__body">
            ...
            <div class="sidebar__btns my-4">
                <a class='sign-in' href='contact.php'>Contact Us</a>
            </div>
